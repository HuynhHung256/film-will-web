<template>
  <div class="mb-6 xl:px-52 md:px-20 w-full border-t-2">
    <div class="grid grid-flow-row grid-cols-6 gap-4 py-10">
      ...
      <div class="col-span-1 flex-col space-y-3 grid justify-items-center">
        ...
        <div class="space-y-4">
          ...
          <h2 class="text-md font-semibold text-gray-900">Download App</h2>
        </div>
        <div>
          <a href="#" class="">
            <img
              src="@/assets/images/application/Google Play.png"
              class="scale-100 hover:scale-125 ease-in duration-300"
              alt="#"
            />
          </a>
        </div>
        <div>
          <a href="#" class="">
            <img
              src="@/assets/images/application/image 6.png"
              class="scale-100 hover:scale-125 ease-in duration-300"
              alt="#"
            />
          </a>
