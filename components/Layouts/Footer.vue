<template>
  <footer class="w-full">
    <div class="md:flex md:justify-between border-t-2 ">
      ...
      <div class="py-8 px-8 grid sm:grid-cols-1">
        <div>
          <h2 class="mr-4 mb-8 text-md font-semibold text-gray-900 dark:text-white">Follow Social Media</h2>
          <ul class="text-gray-600 dark:text-gray-400">
            <span class="mr-10 mb-8 flex space-x-4 scale-125 px-4">
              <a href="#" class="ml-1 text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <span class="mb-4 space-y-4">
              <!--Google Play & AppStore-->
              <h2 class="mb-8 text-md font-semibold text-gray-900 dark:text-white">Download Application Group 14 </h2>
              <a href="#" class="mr-8 ">
                <img src="@/assets/images/application/Google Play.png" class="scale-100 hover:scale-125 ease-in duration-300" alt="#" />
              </a>
              <a href="#" class="mr-8 "> 
                <img src="@/assets/images/application/image 6.png" class="scale-100 hover:scale-125 ease-in duration-300" alt="#" />
              </a>
            </span>
          </ul>
        </div>
    ...
    <div class="px-8 sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
          class="hover:underline">FILM WILL™</a>. All Rights Reserved.
      </span>
      <div class="flex mt-4 mb-2 space-x-6 sm:justify-center sm:mt-0">
