  ...
  <footer class=" border-t-2 max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div class="md:flex md:justify-between">
      ...
      <div class="py-8 px-8 grid sm:grid-cols-1">
        <div>
          <h2 class="mb-8 text-sm font-semibold text-gray-900 dark:text-white">Follow Social Media</h2>
          <ul class="text-gray-600 dark:text-gray-400">
            ...
            <span class="mb-4 space-y-4">
              ...
              <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-white">Download Application Group 14 </h2>
              <a href="#" class="mr-8 ">
